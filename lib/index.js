...
exports.scrapeImages = function (address) { return __awaiter(void 0, void 0, void 0, function () {
    var browser, page, images;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                _a.sent(); // takes the page to a specific url
                return [4 /*yield*/, page.evaluate(function () {
                        var sources = []; // an array of images src
            ...
            case 5:
                // remember to close the broser (invisible chromium)
                _a.sent();
                return [2 /*return*/, images.sources];
        }
    });
}); };
